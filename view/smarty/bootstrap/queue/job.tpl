...
{block name="content_body" append}
    ...
    <dl class="dl-horizontal">
        ...
        <dd id="job-status""><span class="label label-{if $statusString == 'error'}danger{elseif $statusString == 'progress'}warning{else}info{/if}">{translate key="label.status.`$statusString`"}</span></dd>
